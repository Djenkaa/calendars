...
/***/ "./node_modules/kalendar-vue/dist/kalendar-cell-008b4e29.js":
/*!******************************************************************!*\
  !*** ./node_modules/kalendar-vue/dist/kalendar-cell-008b4e29.js ***!
  \******************************************************************/
...
var script = {
  ...
  components: {
    KalendarEvent: function KalendarEvent() {
      return __webpack_require__.e(/*! import() */ 2).then(__webpack_require__.bind(null, /*! ./kalendar-event-1c58280e.js */ "./node_modules/kalendar-vue/dist/kalendar-event-1c58280e.js"));
    }
  },
  computed: {
  ...
  methods: {
    mouseDown: function mouseDown() {
      ...
      var _this$options = this.options,
          read_only = _this$options.read_only,
          overlap = _this$options.overlap,
          past_event_creation = _this$options.past_event_creation;
      if (read_only) return; // if past_event_creation is set to false, check if cell value is
      // before current time

      if (past_event_creation === false) {
        var now = Object(_index_e008937a_js__WEBPACK_IMPORTED_MODULE_0__["g"])(new Date());
      ...
      var payload = {
        creating: true,
        original_starting_cell: Object(_index_e008937a_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this.cellData),
        starting_cell: Object(_index_e008937a_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this.cellData),
        current_cell: Object(_index_e008937a_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this.cellData),
        ending_cell: Object(_index_e008937a_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this.cellData)
      };
    ...
    mouseMove: function mouseMove() {
      ...
      if (creating) {
        var payload = Object(_index_e008937a_js__WEBPACK_IMPORTED_MODULE_0__["b"])({}, this.creator, {
...
var __vue_render__ = function __vue_render__() {
  ...
  return _vm.cellData.visible ? _c('li', {
    ...
    style: "\n    height: " + _vm.options.cell_height + "px;\n  ",
    on: {
