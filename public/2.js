...
/***/ "./node_modules/kalendar-vue/dist/kalendar-event-1c58280e.js":
/*!*******************************************************************!*\
  !*** ./node_modules/kalendar-vue/dist/kalendar-event-1c58280e.js ***!
  \*******************************************************************/
...
/* harmony import */ var _index_e008937a_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-e008937a.js */ "./node_modules/kalendar-vue/dist/index-e008937a.js");
...
var script = {
  ...
  computed: {
    isPast: function isPast() {
      var now = Object(_index_e008937a_js__WEBPACK_IMPORTED_MODULE_0__["g"])(new Date().toISOString());
      return Object(_index_e008937a_js__WEBPACK_IMPORTED_MODULE_0__["h"])(this.event.start.value, now);
    },
    ...
    distance: function distance() {
      ...
      var multiplier = this.options.cell_height / 10; // 0.5 * multiplier for an offset so next cell is easily selected
    ...
    information: function information() {
      var _this$event = this.event,
          ...
          key = _this$event.key;
      return {
        start_time: Object(_index_e008937a_js__WEBPACK_IMPORTED_MODULE_0__["k"])(start.value),
        end_time: Object(_index_e008937a_js__WEBPACK_IMPORTED_MODULE_0__["k"])(end.value),
        kalendar_id: id,
        key: key,
        data: data
      };
